# Generated by Django 3.0.6 on 2020-06-14 07:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_name', models.CharField(max_length=50, verbose_name='Name')),
                ('status', models.BooleanField()),
                ('env', models.CharField(max_length=20, verbose_name='Env')),
                ('version', models.CharField(max_length=5, verbose_name='Version')),
                ('agent_address', models.GenericIPAddressField(validators=[django.core.validators.validate_ipv4_address], verbose_name='IP Address')),
            ],
        ),
        migrations.CreateModel(
            name='Group',
